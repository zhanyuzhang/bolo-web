define(function(require, exports, module) {
	...
	var Module = require('/common/user/1-0-x/modules/Module');
	var FloatWin = require('/common/user/1-0-x/modules/FloatWin');
	var Util = require('/common/user/1-0-x/modules/Util');
	var tmpl = require('/common/user/1-0-x/modules/tmpl');
	var UrsConfig = require('/common/user/1-0-x/modules/Config');
