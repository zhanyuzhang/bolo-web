...
define(function(require, exports, module) {
	...
	var THREE = require('three@78-0-x'),
		DeviceOrientationControls = require('three/78-0-x/modules/DeviceOrientationControls'),
		OrbitControls = require('three/78-0-x/modules/OrbitControls'),
		StereoEffect = require('three/78-0-x/modules/StereoEffect'),
		FirstPersonControls = require('three/78-0-x/modules/FirstPersonControls');
	...
	/*地球皮肤*/
	var earthSkinPic = THREE.ImageUtils.loadTexture('/dev/images/pages/pc/demo/three/texture/earth.jpg');
	/*地球皮肤*/
	var jupiterSkinPic = THREE.ImageUtils.loadTexture('/dev/images/pages/pc/demo/three/texture/jupiter.jpg');
	...
	(function render(timestamp) {
		...
		/*地球自转*/
		stars.Earth.Mesh.rotation.y = (stars.Earth.Mesh.rotation.y == 2*Math.PI ? 0.01*Math.PI : stars.Earth.Mesh.rotation.y+0.01*Math.PI);
		for(var k in stars){
			revolution(stars[k]);
		}
